...
RAW_MATERIALS = ['C:XAGUSD', 'C:COPPER', 'C:OIL', 'C:GAS', 'C:PLATINUM']
CRYPTO_PAIRS= ['X:BTCUSD', 'X:ETHUSD', 'X:LTCUSD', 'X:XRPUSD', 'X:DOGEUSD', 'X:MIOTAUSD', 'X:DASHUSD', 'X:NEOUSD', 'X:EOSUSD']
# Utilizer testC:
