...
CRYPTO_PAIRS= ['X:BTCUSD', 'X:ETHUSD', 'X:LTCUSD', 'X:BCHUSD', 'X:NEOUSD', 'X:DASHUSD', 'X:XRPUSD']
# Utilizer testC:
REQUEST_PAIRS = RAW_MATERIALS + CRYPTO_PAIRS + FOREX_PAIRS
UTIL_PAIRS = FOREX_PAIRS + RAW_MATERIALS + CRYPTO_PAIRS
